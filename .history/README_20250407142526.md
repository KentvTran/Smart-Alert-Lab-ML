...
- Because of these resets, manually recorded time logs may not perfectly align with the actual data timestamps. There's currently no way to detect these resets.