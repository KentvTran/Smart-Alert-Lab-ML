...
##Things to Note
The system resets every now and then and when it does it still takes the full 30 seconds to recalibrate to restart collecting data so the manual notes I have written down doesn't allign with it completely aka it might not be accurate as I have no way of telling when the system resets on its own 